...
g++.exe -c %FLAGS% -std=c++17 "../src/gfx/r_draw_cmdbuf.cpp"
g++.exe -c %FLAGS% -std=c++17 "../src/gfx/r_stream.cpp"
g++.exe -c %FLAGS% -std=c++17 "../src/gfx/r_setstate.cpp"
g++.exe -c %FLAGS% -std=c++17 "../src/gfx/r_shade.cpp"
g++.exe -c %FLAGS% -std=c++17 "../src/gfx/r_state.cpp"
g++.exe -c %FLAGS% -std=c++17 "../src/gfx/rb_tess.cpp"
g++.exe -c %FLAGS% -std=c++17 "../src/gfx/r_draw_lit.cpp"
g++.exe -c %FLAGS% -std=c++17 "../src/gfx/r_rendertarget.cpp"
