...
cd bin
g++.exe -c %FLAGS% "../src/gfx/r_state_utils.cpp"
g++.exe -c %FLAGS% "../src/gfx/r_drawbsp.cpp"
g++.exe -c %FLAGS% "../src/gfx/r_draw_cmdbuf.cpp"
g++.exe -c %FLAGS% "../src/gfx/r_stream.cpp"
g++.exe -c %FLAGS% "../src/gfx/r_setstate.cpp"
