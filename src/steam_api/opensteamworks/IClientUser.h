...
public:
	...
	/* 10 */
	virtual CSteamID GetSteamID() = 0; //Return 0
	virtual CSteamID GetConsoleSteamID() = 0;  //Return 0
	...
	virtual void GetGuestPassToGiveOut() = 0;  //Todo needs to be reserved
	virtual void GetGuestPassToRedeem () = 0;  //Todo needs to be reserved
	...
	virtual void GetAppsInGuestPassesToRedeem () = 0;
...
//	virtual bool SetPasswordFromSteam2( const char *pchPassword ) = 0;
	...
	virtual void SetTwoFactorCode() = 0; //Todo needs to be reserved
...
//	virtual void SetAccountCreationTime( RTime32 rtime32Time ) = 0;
	...
	virtual void BIsPortal2EducationAccount() = 0; //Todo needs to be reserved
	...
	virtual void ValidatePasswordResetCodeAndSendSms()  = 0; //ToDo needs to be reversed
	...
	virtual void UpdateAppOwnershipTickets() = 0;  //ToDo needs to be reversed
	...
	virtual void GetTwoFactorDetails() = 0; //ToDo needs to be reversed
	virtual void BHasTwoFactor() = 0; //ToDo needs to be reversed
	virtual void RecoverAuthenticator() = 0; //ToDo needs to be reversed
	/* 90 */	
...
//	virtual int32 GetSteam2FullASTicket( uint8* pubTicket, int32 cubTicket ) = 0;
	...
	virtual void RequestAccountResetDetails() = 0; //ToDo needs to be reversed
	...
	//STEAMWORKS_STRUCT_RETURN_1(CGameID, GetRunningGameID, int32, iGame)   gone
	virtual CGameID GetRunningGameID( int32 iGame ) = 0;
	virtual uint32 GetRunningGamePID( int32 iGame ) = 0;
	...
	virtual bool BOverlayIgnoreChildProcesses() = 0; //ToDo: Needs to be reversed
	...
	//virtual void PostUIResultToClientJob( uint64 ulJobID, EResult eResult ) = 0;  No more in use
...
//	virtual ESteamGuardProvider GetSteamGuardProvider() = 0; No more in use
	virtual bool GetSteamGuardRequireCodeByDefault() = 0;
//	virtual bool ShowSteamGuardProviderOptions() = 0; No more in use
//	virtual bool SteamGuardProviderMobileIsOption() = 0; No more in use
...
//	virtual void ChangeSteamGuardOptions( const char * pchUnk, ESteamGuardProvider eProvider, bool bRequireCode ) = 0; No more in use
...
//	virtual void OptionalDLCInstallation( AppId_t nAppID, uint32 uUnk, bool bInstall ) = 0; No more in use
	...
	virtual bool GetAppOwnershipInfo( AppId_t unAppId, RTime32* pRTime32Created, char* pchCountry, void* idk ) = 0; // Use a 3 bytes buffer for the country
